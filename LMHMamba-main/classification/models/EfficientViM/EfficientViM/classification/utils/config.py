...
_C.DATA.DATA_PATH = 'C:\\Users\\86133\\Desktop\\AID_dataset'
# Dataset name
_C.DATA.DATASET = 'AID'
# Input image size
...
# Distilation
_C.TRAIN.DISTIILATION = CN()
_C.TRAIN.DISTIILATION.TEACHER_MODEL = 'regnety_160'
_C.TRAIN.DISTIILATION.TEACHER_PATH = 'https://dl.fbaipublicfiles.com/deit/regnety_160-a5fe301d.pth'
_C.TRAIN.DISTIILATION.DISTILLATION_TYPE = 'none'
_C.TRAIN.DISTIILATION.DISTILLATION_ALPHA = 0.5
_C.TRAIN.DISTIILATION.DISTILLATION_TAU = 1.0
...
def update_config(config, args):
    ...
    if _check_args('cooldown_epochs'):
    ...
    if _check_args('distillation_type'):  
        config.TRAIN.DISTIILATION.DISTILLATION_TYPE = args.distillation_type
    # output folder
